...
greet = Label(root, font = ('arial', 17, 'bold'), text = "Welcome to the Typing Speed Test")
greet.grid(row = 0,columnspan = 3)

greet = Label(root, font = ('arial', 17, 'bold'), text = "Type the below sentence")
...
def play():
    ...
    btn = Button(root, text = "Check your speed (or) output",command=check,bg="DodgerBlue2",fg="white", font = ('arial', 10))
